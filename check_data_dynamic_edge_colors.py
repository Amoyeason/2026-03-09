    ...
    for dx in d_vals:
        for dy in d_vals:
            ...
            if save_views and view_dir:
                ...
                inside3d = lift_points_to_surface(nodes_xyz, grid2d_all[inside_flag], k=12) if inside_flag.any() else np.empty((0, 3))
                ok3d = lift_points_to_surface(nodes_xyz, moved2d[keep_flag], k=12) if keep_flag.any() else np.empty((0, 3))
